...
- **Keep OLE Earning Unvested**: Keeping your $OLE earnings unvested entitles you to a 5% Gem bonus every week.
...
- **Bi-weekly OLE Airdrops**: Starting from July 2024, convert Gems into $OLE tokens to capitalize on your social engagements within the platform.
- **Blast Gold Redistribution**: Every epoch, Gems are eligible for redistribution as Blast Gold (Blast Developer Points distributed every 2-3 weeks), with allocations based on the number of Gems earned and the sOLE balance of participants.
- **OLE D1 Airdrop**: The upcoming 50M $OLE Airdrop when OLE is listed in top exchange in 2024 will be allocated based on the total Gems accumulated and the sOLE balance held by participants.
