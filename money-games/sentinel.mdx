...
### Quorum Dynamics
- **Minimum Quorum**: A minimum three participants is required to proceed with the bet.
- **Maximum Quorum**: There is a cap on participant numbers to ensure quality and prevent majority tyranny.
