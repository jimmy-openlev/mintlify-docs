...
- **Daily Blast Gold Distribution:**
    - 133,333 Blast Gold will be distributed to all successful launches daily, pro-rata to users based on their participation (buy-in Meme coin with ETH) in each Social Launch, before trading start on DEX. 800k Gold in total.
